...
namespace CompanyG02.Data
{
    internal class CompanyDBContext : DbContext //Base Class For Every Context 
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server=DESKTOP-OK3UQ3L;Database=Company;Integrated Security =True ; TrustServerCertificate=True");//new syntax
            
            optionsBuilder.UseLazyLoadingProxies();  // enable the lazy loading mode 
        }
